...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ʀʏᴛʜᴍ ✘ ᴍᴜsɪᴄ")

OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5567639956").split())
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Vikku1343/RythmMusicBot",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/ISHQSUFIIYANA")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/LIFELINEENJOY")
